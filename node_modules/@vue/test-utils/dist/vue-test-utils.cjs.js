...
function requireAcorn () {
	...
	(function (exports$1) {
		...
		exports$1.identifierMatch = new RegExp("(?:\\\\u[0-9a-fA-F]{4}|[" + baseASCIIidentifierChars + nonASCIIidentifierStartChars + nonASCIIidentifierChars + "])+");
...
class DOMWrapper extends BaseWrapper {
    ...
    getRootNodes() {
        var _a;
        if (Array.isArray((_a = this.subTree) === null || _a === void 0 ? void 0 : _a.children)) {
    ...
    setData(data) {
        ...
        */
        ...
        if (this.componentVM.$.setupState.__isScriptSetup) {
            ...
            // @ts-expect-error
            mergeDeep(Vue.proxyRefs(this.componentVM.$.setupState), data);
        }
        else {
...
function processSlot(source = '', Vue = Vue__namespace) {
    ...
    // transition
    const { code } = compilerDom.compile(`<transition>${template}</transition>`, {
        mode: 'function',
...
const isKeepAlive = (type) => type.__isKeepAlive;
...
const DEFAULT_STUBS = {
    ...
    transition: (type) => type === Vue.Transition || type === Vue.BaseTransition,
    'transition-group': (type) => type === Vue.TransitionGroup
};
...
inputComponent, options) {
    ...
    if (isFunctionalComponent(originalComponent) ||
        ...
        component = Vue.defineComponent(Object.assign({ compatConfig: {
                MODE: 3,
                ...
                COMPONENT_FUNCTIONAL: isLegacyFunctionalComponent(originalComponent)
                    ? 'suppress-warning'
                    : false
            }, props: originalComponent.props || {}, setup: (props, { attrs, slots }) => () => Vue.h(originalComponent, Object.assign(Object.assign({}, props), attrs), slots) }, instanceOptions));
        ...
        if (isObjectComponent(originalComponent)) {
            ...
            if (originalComponent.data) {
                ...
                objectComponent.setup = function (a, b) {
                    ...
                    mergeDeep(Vue.proxyRefs(data), providedData);
                    return data;
                };
            }
            else {
    ...
    const refs = Vue.shallowReactive({});
    ...
    const Parent = Vue.defineComponent({
        ...
        render() {
            return Vue.h(component, Object.assign(Object.assign({}, props), refs), slots);
        }
    });
    // create the app
...
function mount(inputComponent, options) {
    ...
    if (options === null || options === void 0 ? void 0 : options.attachTo) {
        ...
        to.appendChild(el);
        app.onUnmount(() => {
            to === null || to === void 0 ? void 0 : to.removeChild(el);
        });
    }
...
const RouterLinkStub = Vue.defineComponent({
    name: 'RouterLinkStub',
    compatConfig: { MODE: 3 },
    props: {
        to: {
    ...
    render() {
        var _a, _b;
        const route = Vue.computed(() => defaultRoute);
        ...
        const children = (_b = (_a = this.$slots) === null || _a === void 0 ? void 0 : _a.default) === null || _b === void 0 ? void 0 : _b.call(_a, {
            ...
            isActive: Vue.computed(() => false),
            isExactActive: Vue.computed(() => false),
